...
public class JdbcApp {
	public static void hello(String[] args) throws SQLException {
		...
		do {
			 ...
			 * System.out.println("Enter the id of the student to be deleted: "); int id =
			 * sc.nextInt(); Student st = sDao.getOne(id); System.out.println(st); do {
			 * System.out.println("Confirm Delete(y/n):"); ch = sc.next();
			 * }while(!(ch.equalsIgnoreCase("y")||ch.equalsIgnoreCase("n")));
			 * if(ch.equalsIgnoreCase("y")){ i = sDao.delete(id); if(i==1) {
